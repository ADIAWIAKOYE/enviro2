...
add_submenu_page( 'options-general.php', 'Sticky Anything', 'Sticky Anything', 'manage_options', 'toast_sticky_anything', 'toast_si_options_page' );
}
function toast_si_options_page(){ 

	?>
	<div class="wrap">
	<h2>Sticky Anything <span class="toast-version-number">Version 2.1.5</span></h2>
